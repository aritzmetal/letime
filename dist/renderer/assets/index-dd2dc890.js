...
const headerLogo = "" + new URL("header-logo-4bbb45fc.svg", import.meta.url).href;
/*! *****************************************************************************
...
var ComboboxContext = reactExports.createContext({
...
var useComboboxContext = function() {
  return reactExports.useContext(ComboboxContext);
};
...
function useComboboxHelpers(_a) {
  ...
  var expandOnFocus = reactExports.useCallback(function() {
    if (!isExpandedRef.current && setIsExpanded)
      setIsExpanded(true);
  }, [setIsExpanded]);
  var handleCloseDatalist = reactExports.useCallback(function() {
    if (isExpandedRef.current && setIsExpanded)
      setIsExpanded(false);
  }, [setIsExpanded]);
  var closeOnEscape = reactExports.useCallback(function(e) {
    if (e.key === "Escape")
      handleCloseDatalist();
  }, []);
  var handleClickOutside = reactExports.useCallback(function(e) {
  ...
  var handleFocusOutside = reactExports.useCallback(function() {
    if (!comboboxInputRef.current || !listboxRef.current)
      return;
  ...
  var handleKeyDownOnInput = reactExports.useCallback(function(e) {
  ...
  var handleKeyDownOnListboxOption = reactExports.useCallback(function(e) {
    if (!itemsRef.current)
      return;
...
var ComboboxInput = reactExports.forwardRef(function(_a, forwardedRef) {
  ...
  return React.createElement("input", __assign({ autoComplete: "off" }, props, { ref: forwardedRef, value, type: "text", role: "combobox", "aria-autocomplete": "list", "aria-haspopup": "listbox", "aria-expanded": isExpanded, "aria-controls": listboxId }));
});
...
var Highlight = function(_a) {
  ...
  var markedChildren = reactExports.useMemo(function() {
    if (typeof children !== "string") {
      return children;
    }
    var index2 = children.toLowerCase().indexOf(currentInput.toLowerCase());
    var inputLength = currentInput.length;
    if (index2 === -1 || !inputLength) {
      return children;
    }
    return React.createElement(
      React.Fragment,
      null,
      children.substring(0, index2),
      as === "mark" ? React.createElement("mark", __assign({}, props), children.substring(index2, index2 + inputLength)) : React.createElement("span", __assign({}, props), children.substring(index2, index2 + inputLength)),
      children.substring(index2 + inputLength, children.length)
    );
  }, [currentInput, children]);
  return React.createElement(React.Fragment, null, markedChildren);
};
var ListboxOption = reactExports.forwardRef(function(_a, forwardedRef) {
  var children = _a.children, id2 = _a.id, className = _a.className, props = __rest(_a, ["children", "id", "className"]);
  var selectedItemId = useComboboxContext().selectedItemId;
  var classNameStr = useClassNameStr(className, {
    isSelected: !!id2 && id2 === selectedItemId
  });
  return React.createElement("li", __assign({}, props, { ref: forwardedRef, id: id2, className: classNameStr, role: "option" }), children);
});
ListboxOption.displayName = "ListboxOption";
var Listbox = reactExports.forwardRef(function(_a, forwardedRef) {
  var children = _a.children, props = __rest(_a, ["children"]);
  var _b = useComboboxContext(), contextAvailable = _b.contextAvailable, listboxId = _b.listboxId, isExpanded = _b.isExpanded;
  assertWithWarning(contextAvailable, contextRequiredWarning(Listbox.name));
  var isExpandedRef = reactExports.useRef(isExpanded);
  var _c = reactExports.useState(false), hasExpanded = _c[0], setHasExpanded = _c[1];
...
var Combobox = function(_a) {
  ...
  var id2 = reactExports.useId();
  return React.createElement(ComboboxContext.Provider, { value: { currentInputValue, contextAvailable: true, listboxId: listboxId || id2, selectedItemId, isExpanded } }, children);
};
...
var useInternalValue = function(value, setValue) {
  var _a = reactExports.useState(value || ""), internalValue = _a[0], setInternalValue = _a[1];
  var setValues = reactExports.useCallback(function(newValue) {
    if (setValue) {
      setValue(newValue);
    } else {
...
function useInternalSelectedItem(item) {
  var _a = reactExports.useState(item), selectedItem = _a[0], setSelectedItem = _a[1];
  reactExports.useEffect(function() {
    setSelectedItem(item);
  }, [item]);
...
function useFilters(items, value, filters) {
  var filteredRef = reactExports.useRef(items);
  var filtered = reactExports.useMemo(function() {
...
var DatalistInput = reactExports.forwardRef(function(_a, forwardedRef) {
  ...
  var internalTextboxId = reactExports.useId();
  var debounceValue = reactExports.useDeferredValue(internalValue);
  var _j = useFilters(items, debounceValue, filters), filteredItems = _j[0], filteredItemsRef = _j[1];
  var listboxRef = reactExports.useRef(null);
  var comboboxInputRef = reactExports.useRef(null);
  var _k = useInternalSelectedItem(selectedItem), internalSelectedItem = _k[0], setSelectedItem = _k[1];
  var setIsExpandedStates = reactExports.useCallback(function(state) {
  ...
  return React.createElement(
    ...
    React.createElement(
      Combobox,
      { listboxId: listboxProps === null || listboxProps === void 0 ? void 0 : listboxProps.id, selectedItemId: internalSelectedItem === null || internalSelectedItem === void 0 ? void 0 : internalSelectedItem.id, isExpanded: internalIsExpanded, currentInputValue: internalValue },
...
const navbar = "";
const clockLogo = "" + new URL("clock-logo-506d3209.svg", import.meta.url).href;
const navbarActionButtons = "";
const minimize = "" + new URL("Minimize-9aa4342c.svg", import.meta.url).href;
const maximize = "" + new URL("Maximize-706a9b1a.svg", import.meta.url).href;
const close = "" + new URL("Close-498c06db.svg", import.meta.url).href;
...
const NavbarActionButtons = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${BASE_CLASSNAME}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${BASE_CLASSNAME}--content`, children: BUTTONS.map((b) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `${BASE_CLASSNAME}--content-inner`,
        style: { display: "flex", margin: "auto" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: b.id, className: `${BASE_CLASSNAME}--button`, disabled: !b.enabled, onClick: () => {
          b.action && b.action();
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: b.icon, height: "16px" }) })
      },
      `item-${b.id}`
    );
  }) }) }) });
...
const Navbar = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${NAVBAR_BASE_CALSSNAME}-navbar`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${NAVBAR_BASE_CALSSNAME}-navbar--header`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${NAVBAR_BASE_CALSSNAME}-navbar--header-logo`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: clockLogo, height: "20px" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${NAVBAR_BASE_CALSSNAME}-navbar--header-name`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${NAVBAR_BASE_CALSSNAME}-navbar--header-content`, style: { color: "white" }, children: "Letime" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(NavbarActionButtons, {})
  ] });
};
function getTimeInTimeZone(timezone, newOptions) {
...
function App() {
  const [fullHours, setFullHours] = reactExports.useState(false);
  const [value, setValue] = reactExports.useState(/* @__PURE__ */ new Date());
  const [timezone, setTimezone] = reactExports.useState("Europe/Andorra");
  reactExports.useEffect(() => {
    const interval = setInterval(() => setValue(/* @__PURE__ */ new Date()), 1e3);
    return () => {
      clearInterval(interval);
    };
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "root-node", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "row", marginTop: "auto", marginBottom: "auto", padding: "2px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "row", marginTop: "auto", marginBottom: "auto", padding: "2px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: headerLogo, height: "48px" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "row", marginTop: "auto", marginBottom: "auto", padding: "2px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: "empty-button",
          onClick: () => setFullHours((prev) => !prev),
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { margin: "12px", padding: "12px" }, children: timezone && getTimeInTimeZone(timezone, { hour12: fullHours }) })
        }
      ) })
    ] })
  ] }) });
